				...
				<div class="sidebar">
					...
					<ul class="sidebar-menu"> 
						...
						<li class="treeview wallet <?php echo (($this->uri->segment(2) == "package")? "active":null)?>">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?php echo (($this->uri->segment(2) == "package" && $this->uri->segment(3) == null)? "active":null)?>"><a href="<?php echo base_url("customer/package") ?>"><i class="fa fa-cubes" aria-hidden="true"></i> Package</a></li>
                                <li class="<?php echo (($this->uri->segment(3) == "investment")? "active":null)?>"><a href="<?php echo base_url("customer/package/investment") ?>"><i class="fa fa-diamond" aria-hidden="true"></i> My Package</a></li>
