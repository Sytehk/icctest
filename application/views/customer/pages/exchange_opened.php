                ...
                <table class="table table-bordered table-hover" style="font-size:12px">
                    <thead>
                        <tr> 
                            ...
                            <th>Crypto Qty</th>
                            <th>Crypto Rate(<?php echo $coininfo->pair_with; ?>)</th>
                            <th>Complete Qty</th>
                            <th>Available Qty</th>
                            <th>Datetime</th>
                            <th>Status</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url("customer/exchange/exchange_cancel/$value->id") ?>" class="btn btn-danger btn-xs" title="Cancel">Cancel</a></td>
                        </tr>
                        <?php $sl++; } ?>                    
                    </tbody>
                </table>
