                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="border_preview">
                            <?php echo form_open('customer/settings/payment_method_update/bitcoin');?>

                                <div class="form-group row">
                                    <label  class="col-sm-12 col-form-label"><?php echo display('bitcoin_wallet_id');?> <span class="text-danger">*</span></label>
                                    <div class="col-sm-12">
                                        <input class="form-control" name="wallet_id" value="<?php echo @$bitcoin->wallet_id;?>" required type="text">
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="border_preview">
                            <?php echo form_open('customer/settings/payment_method_update/payeer');?>

                                <div class="form-group row">
                                    <label  class="col-sm-12 col-form-label"><?php echo display('payeer_wallet_id');?> <span class="text-danger">*</span></label>
                                    <div class="col-sm-12">
                                        <input class="form-control" name="wallet_id" value="<?php echo @$payeer->wallet_id;?>" required type="text">
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="border_preview">
                            <?php echo form_open('customer/settings/payment_method_update/paypal');?>
