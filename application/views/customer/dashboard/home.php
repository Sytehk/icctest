                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="count_panel panel-blue">
                                ...
                                <i class="fa fa-info-circle" data-toggle="tooltip" data-original-title="Summation of all your buy and exchange calculate token.  "></i>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4">
                            <div class="count_panel panel-seven">
                                ...
                                <i class="fa fa-info-circle" data-toggle="tooltip" data-original-title="Multiplication of all token and token rate.  "></i>
                            </div>
                        </div>
