            ...
            <div class="panel-body">
                ...
                <input name="symbol" value="<?php echo $coinpair->symbol  ?>" class="form-control" type="hidden" id="symbol">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="name" value="<?php echo $coinpair->name ?>" class="form-control" placeholder="<?php echo display('name') ?>" type="text" id="name">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="full_name" class="col-sm-4 col-form-label">Full Name</label>
                        <div class="col-sm-8">
                            <input name="full_name" value="<?php echo $coinpair->full_name ?>" class="form-control" placeholder="Full Name" type="text" id="full_name">
                        </div>
                    </div>                    
                    <div class="form-group row">
                        <label for="market_id" class="col-sm-4 col-form-label">Market<i class="text-danger">*</i></label>
                        <div class="col-sm-8">
                            <select class="form-control basic-single" name="market_id" id="market_id">
                                ...
                                <?php foreach ($market as $key => $value) { ?>
                                    <option value="<?php echo $value->symbol; ?>" <?php echo ($coinpair->market_symbol==$value->symbol)?'Selected':'' ?>><?php echo $value->full_name; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <select class="form-control basic-single" name="coin_id" id="coin_id">
                                ...
                                <?php foreach ($coins as $key => $value) { ?>
                                    <option value="<?php echo $value->symbol; ?>" <?php echo ($coinpair->currency_symbol==$value->symbol)?'Selected':'' ?>><?php echo $value->coin_name; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
