                ...
                <?php echo form_hidden('cat_id', $category->cat_id) ?> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="radio">
                            <label>
                                <?php echo form_radio('menu', '2', (($category->menu==2)?true:false)); ?>Footer 1
                             </label>
                             </div>
                            <div class="radio">
                            <label>
                                <?php echo form_radio('menu', '3', (($category->menu==3)?true:false)); ?>Footer 2
                             </label>
                             </div>
                            <div class="radio">
                            <label>
                                <?php echo form_radio('menu', '4', (($category->menu==4)?true:false) ); ?>Top and Footer 1
                             </label>
                             </div> 
                            <div class="radio">
                            <label>
                                <?php echo form_radio('menu', '5', (($category->menu==5)?true:false) ); ?>Top and Footer 2
                             </label>
                             </div> 
                            <div class="radio">
                            <label>
