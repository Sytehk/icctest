            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', $article->article_id) ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input name="article1_en" value="<?php echo htmlspecialchars($article->article1_en) ?>" class="form-control" placeholder="<?php echo display('short_description_en') ?>" type="text" id="article1_en">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article1_fr" class="col-sm-2 col-form-label"><?php echo display('short_description_en')." ".$web_language->name ?></label>
                        <div class="col-sm-10">
                            <input name="article1_fr" value="<?php echo htmlspecialchars($article->article1_fr) ?>" class="form-control" placeholder="<?php echo display('short_description')." ".$web_language->name ?>" type="text" id="article1_fr">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article2_en" class="col-sm-2 col-form-label">Market Capacity</label>
                        <div class="col-sm-10">
                            <input name="article2_en" value="<?php echo htmlspecialchars($article->article2_en) ?>" class="form-control" placeholder="" type="text" id="article2_en">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article2_fr" class="col-sm-2 col-form-label">Capacity Text</label>
                        <div class="col-sm-10">
                            <input name="article2_fr" value="<?php echo htmlspecialchars($article->article2_fr) ?>" class="form-control" placeholder="" type="text" id="article2_fr">
                        </div>
                    </div>
                    <div class="form-group row">
