            ...
            <div class="panel-body">
                ...
                <?php echo form_hidden('article_id', $article->article_id) ?> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input name="article1_en" class="form-control" type="text" id="article1_en" value="<?php echo htmlspecialchars($article->article1_en) ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="article1_fr" class="col-sm-2 col-form-label"><?php echo "Text"." ".$web_language->name ?></label>
                        <div class="col-sm-10">
                            <input name="article1_fr" class="form-control" type="text" id="article1_fr" value="<?php echo htmlspecialchars($article->article1_fr) ?>">
                        </div>
                    </div>
                    <div class="row">
