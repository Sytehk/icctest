...
class Content extends CI_Controller {
	...
	public function form($article_id = null)
	{
		...
		$this->form_validation->set_rules('headline_en', display('headline_en'),'required|max_length[1000]');
		...
		$data['article']   = (object)$userdata = array(
			...
			'article2_en' 		=> strip_tags($this->input->post('article2_en')),
			'article2_fr' 		=> strip_tags($this->input->post('article2_fr')),
