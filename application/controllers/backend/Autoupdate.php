...
//Get Update file
define('MIN_VERSION', file_get_contents('http://update.bdtask.com/icowallet/autoupdate/update_min_version'));
//Get Update file
define('MAX_VERSION', file_get_contents('http://update.bdtask.com/icowallet/autoupdate/update_max_version'));

//Get Update file
define('UPDATE_URL','http://update.bdtask.com/icowallet/autoupdate');
