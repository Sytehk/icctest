                                            ...
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="userid" name="userid" value="raz0r" placeholder="User ID" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="password" class="form-control" id="purchase_key" value="valid"  name="purchase_key"  placeholder="Purchase Key" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="step-content step-five">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="alert alert-success">
                                                    <strong>Your application installed successfully !!! visit <a href="https://bit.ly/2QCCRlD" target="_blank">WarezzZ!</a></strong>
                                                </div>
                                                <?php } ?>
